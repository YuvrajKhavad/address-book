					...
					<div class="panel-body">
						<div class="conatiner">
							<div class="row" style="font-family: 'Baloo Bhaina', cursive;">
								<div class="col-sm-6">
									<button id="login" class="btn btn-lg btn-info" data-toggle="modal"
										data-target="#loginPop">Login</button>
								</div>
								<div class="col-sm-6">
									<button id="register" class="btn btn-lg btn-warning" data-toggle="modal"
										data-target="#registerPop">Register</button>
								</div>
							</div>
						</div>
					</div>
