<form class="form-vertical" role="form" id="SearchFormVillage">
	<div class="form-group mb-2">
		<select id="" name="search-district" class="search-districts">
			<option value="">જિલ્લો પસંદ કરો</option>
			<?php
			$res = mysqli_query($con, "SELECT DISTINCT `District_Name` FROM `location` WHERE `District_Name` != ''");
	...
	<div class="form-group mb-2 search-talukas-list">
	</div>

	<div class="form-group mx-sm-3 mb-2">
		<input type="submit" class="btn btn-success mb-2 search-village-data" value="Search Village"/>
	</div>
</form>
<div id = "village-message"></div>
